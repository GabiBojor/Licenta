...
var CurrentWeather = /** @class */ (function () {
    function CurrentWeather(cityName, temp, icon, weatherKind, humidity, tempMax, tempMin) {
...
var CurrentComponent = /** @class */ (function () {
    ...
    CurrentComponent.prototype.onSubmit = function (weatherForm) {
        ...
        this.ws.anotherCityWeather(weatherForm.value.city).subscribe(function (data) {
            _this.myWeather = new _current_weather__WEBPACK_IMPORTED_MODULE_4__["CurrentWeather"](data.name, data.main.temp, data.weather[0].icon, data.weather[0].description, data.main.humidity, data.main.temp_max, data.main.temp_min);
        });
    };
...
var Forecast = /** @class */ (function () {
    function Forecast(day, icon, tempMax, tempMin) {
        this.day = day;
        this.icon = icon;
        this.tempMax = tempMax;
        this.tempMin = tempMin;
    ...
    ForecastComponent.prototype.onSubmit = function () {
        ...
        this.weatherService
            ...
            for (var i = 0; i < data.list.length; i += 8) {
                var temporary = new _forecast__WEBPACK_IMPORTED_MODULE_3__["Forecast"](data.list[i].dt_txt, data.list[i].weather[0].icon, data.list[i].main.temp_max, data.list[i].main.temp_min);
...
var weatherRouting = _angular_router__WEBPACK_IMPORTED_MODULE_2__["RouterModule"].forRoot(WEATHER_ROUTER);
        ...
        return new Promise(function (res, rej) {
            navigator.geolocation.getCurrentPosition(function (pos) {
                ...
                return _this.http
                    ...
                    .then(function (data) {
                    console.log(data);
                    _this.myWeather = new _current_weather__WEBPACK_IMPORTED_MODULE_2__["CurrentWeather"](data.name, data.main.temp, data.weather[0].icon, data.weather[0].description, data.main.humidity, data.main.temp_max, data.main.temp_min);
                    res(_this.myWeather);
                });
            });
        });
